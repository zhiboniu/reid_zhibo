...
def train(cfg):
    ...
    if cfg.MODEL.IF_WITH_CENTER == 'no':
        ...
        loss_func, center_criterion, norm_m = make_loss_with_center(cfg, num_classes)  # modified by gu
        optimizer, optimizer_center, optimizer_am = make_optimizer_with_center(cfg, model, center_criterion, norm_m)
        # scheduler = WarmupMultiStepLR(optimizer, cfg.SOLVER.STEPS, cfg.SOLVER.GAMMA, cfg.SOLVER.WARMUP_FACTOR,
        #                               cfg.SOLVER.WARMUP_ITERS, cfg.SOLVER.WARMUP_METHOD)
